...
var model = {
  ...
  columns: {
    "HEN": {
      ...
      active: false,
      icon: 'gamepad',
      items: [{ title: "VTXHEN", subtitle: "1.7(xVortex)", active: true, icon: "lock", expage: "payloads/vtxhen.html" },{ title: "MIRAHEN", subtitle: "1.7(OpenOrbisTeam)", active: true, icon: "apps", expage: "payloads/mirahen.html" }, { title: "BINLOADER", subtitle: "PORT:9020", active: false, icon: "send", expage: "payloads/binloader.html" }, { title: "MIRAHEN+BINLOADER", subtitle: "1.7(OpenOrbisTeam)", active: true, icon: "input", expage: "payloads/mirahen.html" }]
    },
    "BLOCKS": {
      index: 1,
      title: "BLOCKZ",
    ...
    "LINUX": {
      ...
      active: false,
      icon: "laptop",
      items: [{ title: "LINUX", subtitle: "1.0(Vultra)", active: false, icon: "keyboard", expage: "payloads/linux.html"}, { title: "KEXEC", subtitle: "1.0(ValentineBreize)", active: false, icon: "widgets", expage: "payloads/apptousb.html"}]
    },
    "BACKUP": {
      index: 3,
      title: "BACKUP",
  ...
  "TOOLS": {
	...
	"CHEATS": {
      ...
      active: false,
      icon: "search",
      items: [{ title: "PS4TRAINER", subtitle: "1.3.41.58(Tylermods)", active: false, icon: "code", expage: "payloads/tylermodsloader.html" }, { title: "PS4CHEATER", subtitle: "1.4.5(Chendochap)", active: false, icon: "create", expage: "payloads/cheater.html" }, { title: "PS4API", subtitle: "1.0(Helloitu)", active: false, icon: "flag", expage: "payloads/ps4api.html" }]
    },
  "MENUS": {
      index: 7,
      title: "MENUS",
      ...
      active: false,
      icon: "tune",
      items: [{ title: "APII_INTENSE_EU_1.27", subtitle: "2.0(EROOTIIK)", active: false, icon: "build", expage: "payloads/intense127loader.html" },{ title: "LAMANCE", subtitle: "0.8(David1337hax)", active: false, icon: "stars", expage: "payloads/lamanceloader.html" }, { title: "PSYC0S", subtitle: "1.0(AlFaMoDz)", active: false, icon: "grade", expage: "payloads/psyc0sloader.html" }, { title: "LTSmenubase", subtitle: "1.0(CMTFrostyy)", active: false, icon: "pets", expage: "payloads/ltsmenuloader.html" }, { title: "127_NATIVE_CALLER", subtitle: "1.0(CMTFrostyy)", active: false, icon: "accessibility", expage: "payloads/127nativeloader.html" }, { title: "APII_INTENSE", subtitle: "1.1(EROOTIIK)", active: false, icon: "extension", expage: "payloads/intenseloader.html" }, { title: "WILDEMODZ", subtitle: "1.1(Wildemodz)", active: false, icon: "toys", expage: "payloads/wildemodzloader.html" }, { title: "TRAINER", subtitle: "1.0(David1337hax)", active: false, icon: "shop", expage: "payloads/trainerloader.html" }, { title: "NOTANOTHER", subtitle: "1.0(David1337hax)", active: false, icon: "gesture", expage: "payloads/notanotherloader.html" }, { title: "ARABICGUY", subtitle: "1.0(ARABICGUY)", active: false, icon: "face", expage: "payloads/arabicloader.html" }]
    },
	"CACHE": {
      index: 8,
      title: "CACHE",
